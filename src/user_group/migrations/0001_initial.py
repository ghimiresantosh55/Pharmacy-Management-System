    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_date_ad', models.DateTimeField(default=django.utils.timezone.now)),
                ('created_date_bs', models.CharField(max_length=10)),
                ('category', models.ForeignKey(blank=True, help_text='null=True, blank=True', null=True, on_delete=django.db.models.deletion.PROTECT, to='user_group.permissioncategory')),
            ],
        ),
        migrations.CreateModel(
            name='CustomGroup',

...
def get_item_ledger(filterset):
    query = PurchaseDetail.objects.all().values('created_date_ad', 'created_date_bs', 'qty') \
        .annotate(item_name=F('item__name'),
                  ...
                  bill_date_ad =F('purchase__bill_date_ad'),
                  bill_date_bs =F('purchase__bill_date_bs'),
                  batch_no =F('batch_no'),
                  bill_no =F('purchase__bill_no'),
        ...
        .union(SaleDetail.objects.all().values('created_date_ad', 'created_date_bs', 'qty') \
               .annotate(item_name=F('item__name'),
                         ...
                         bill_date_ad =F('ref_purchase_detail__purchase__bill_date_ad'),
                         bill_date_bs =F('ref_purchase_detail__purchase__bill_date_bs'),
                         batch_no=F('ref_purchase_detail__batch_no'),
                         bill_no=F('ref_purchase_detail__purchase__bill_no'),
                         cost=F('cost'),
                         op_type=Case(

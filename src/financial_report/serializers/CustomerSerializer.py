...
class BasicPartyPaymentSummaryReportSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields =['id','first_name', 'middle_name', 'last_name', 'total_purchase_cash', 'total_purchase_credit', 'total_purchase_return_cash',
        'total_purchase_return_credit', 'party_payment_payment', 'party_payment_payment_return', 'to_be_paid', 'paid_amount', 'adv_due_amount']
        read_only_fields=['id','first_name', 'middle_name', 'last_name', 'total_purchase_cash', 'total_purchase_credit', 'total_purchase_return_cash',
        'total_purchase_return_credit', 'party_payment_payment', 'party_payment_payment_return', 'to_be_paid', 'paid_amount', 'adv_due_amount']
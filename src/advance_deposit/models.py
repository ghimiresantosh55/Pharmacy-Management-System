...
class AdvancedDeposit(NowTimestampAndUserModel):
    DEPOSIT_TYPE = (
        (1, "DEPOSIT"),
        (2, "DEPOSIT-RETURN"),
    )
...
class AdvancedDepositPaymentDetail(NowTimestampAndUserModel):
...
# "advanced_deposit":{
#     "order_maste ": 1,
#     "sale_master": "null for now",
#     "amount": 800,
#     "remarks":"remarks for advanced deposit",
#     "advanced_deposit_payment_details":[{
#         "payment_mode":1,
#         "amount": 500,

...
from src.core_app.models import NowTimestampAndUserModel, PaymentMode, FiscalSessionAD, FiscalSessionBS
...
class SaleMaster(NowTimestampAndUserModel):
    SALE_TYPE = (
        (1, "SALE"),
        (2, "RETURN")
    )
    ...
    total_tax = models.DecimalField(max_digits=12, decimal_places=2, default=0.0, help_text="Total tax can have max value upto=9999999999.99 and default=0.0")
...
class SaleDetail(NowTimestampAndUserModel):
    ...
    pack_qty = models.DecimalField(max_digits=12, decimal_places=2, validators=[MinValueValidator(Decimal('0.00'))], help_text="pack quantity can't be negative")
    ...
    ref_purchase_detail = models.ForeignKey(PurchaseDetail, default=False,
